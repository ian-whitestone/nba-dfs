...
```{r echo=TRUE, message=FALSE, warning=FALSE, results = 'hide'}
base_starter_data = player_data[starter ==1,.(gameID,team,fd,position)]
starter_data = dcast(base_starter_data,gameID + team ~ position, fun.aggregate = mean, value.var = c('fd'))
...
corrplot.mixed(C5,lower="number",upper='circle',col=col2(10))
```
