...
- Missing just one value of split for a date (country_code = 2), base or child
- Missing one value of split in a child
- New values in a field
- Distribution of values change
- Duplicate data
- Include cyclicality somehow (weekly mostly, but monthly too)
    + Think about cycle dates
